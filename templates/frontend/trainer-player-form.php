<?php
// Plik: templates/frontend/trainer-player-form.php
...
<div class="wrap">
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" class="fcm-form">
        ...
        <div class="fcm-form-group">
            ...
            <input type="text" id="imie_nazwisko" name="imie_nazwisko" value="<?php echo esc_attr($zawodnik->imie_nazwisko ?? ''); ?>" class="fcm-form-control" required>
        </div>
        <div class="fcm-form-group">
        ...
        <div class="fcm-form-group">
            <label for="liczba_treningow">Liczba treningów</label>
            <input type="number" id="liczba_treningow" name="liczba_treningow" value="<?php echo esc_attr($zawodnik->liczba_treningow ?? 10); ?>" class="fcm-form-control" min="0">
        </div>
        <div class="fcm-form-group">
            <label for="parent_id">Przypisany Rodzic</label>
            <select name="parent_id" id="parent_id" class="fcm-form-control">
        ...
        <?php submit_button($zawodnik ? 'Zapisz zmiany' : 'Dodaj zawodnika', 'primary', 'fcm_save_player'); ?>
    </form>
    <a href="<?php echo esc_url(add_query_arg(['fcm_action' => 'players'])); ?>" class="button">&laquo; Powrót do listy</a>

    <?php if ($zawodnik) : ?>
    <div id="historia-obecnosci" class="fcm-section-card">
