<?php // templates/frontend/trainer-rodzice-pending.php
global $wpdb;
            ...
            <?php if ($pending_requests) : ?>
                <?php foreach ($pending_requests as $request) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo wp_nonce_url(add_query_arg(['fcm_action' => 'parents_admin', 'action' => 'approve_powiazanie', 'powiazanie_id' => $request->id], get_permalink()), 'approve_' . $request->id); ?>" class="button button-primary">Zatwierdź</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else : ?>
