                ...
                <?php foreach ($harmonogramy as $harmonogram) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo wp_nonce_url(admin_url('admin-post.php?action=fcm_delete_schedule_frontend&schedule_id=' . $harmonogram->id), 'delete_schedule_' . $harmonogram->id); ?>" class="button button-danger">Usuń</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else : ?>
