<?php // templates/frontend/trainer-rodzice-list.php
global $wpdb;
            ...
            <?php if ($rodzice) : ?>
                <?php foreach ($rodzice as $rodzic) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo esc_url(add_query_arg(['fcm_action' => 'parents_admin', 'action' => 'edit', 'rodzic_id' => $rodzic->id])); ?>" class="button">Edytuj</a>
                            <a href="<?php echo wp_nonce_url(add_query_arg(['fcm_action' => 'parents_admin', 'action' => 'delete_parent', 'rodzic_id' => $rodzic->id], get_permalink()), 'delete_parent_' . $rodzic->id); ?>" class="button button-danger">Usuń</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else : ?>
