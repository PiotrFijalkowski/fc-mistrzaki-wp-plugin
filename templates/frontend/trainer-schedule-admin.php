<?php // templates/frontend/trainer-schedule-admin.php
            ...
            <?php if ($harmonogramy) : ?>
                <?php foreach ($harmonogramy as $harmonogram) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo esc_url(add_query_arg(['fcm_action' => 'schedule', 'action' => 'edit_schedule', 'schedule_id' => $harmonogram->id])); ?>" class="button">Edytuj</a>
                            <a href="<?php echo wp_nonce_url(add_query_arg(['fcm_action' => 'schedule', 'action' => 'delete_schedule', 'schedule_id' => $harmonogram->id], get_permalink()), 'delete_schedule_' . $harmonogram->id); ?>" class="button button-danger">Usuń</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else : ?>
