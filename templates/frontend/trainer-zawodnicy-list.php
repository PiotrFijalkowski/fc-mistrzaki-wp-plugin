<?php
// Plik: templates/frontend/trainer-zawodnicy-list.php
...
<div class="wrap">
    ...
    <a href="<?php echo esc_url(add_query_arg(['fcm_action' => 'players_admin', 'action' => 'add'], get_permalink())); ?>" class="page-title-action button button-primary">Dodaj nowego</a>
        ...
        <tbody>
            ...
            if ($zawodnicy) {
                foreach ($zawodnicy as $zawodnik) {
                    ...
                    $delete_url = wp_nonce_url(add_query_arg(['fcm_action' => 'players_admin', 'action' => 'delete_zawodnik', 'id' => $zawodnik->id], get_permalink()),'fcm_delete_zawodnik_nonce_action_' . $zawodnik->id,'fcm_delete_nonce');
                    ...
                    echo '<td><a href="' . esc_url(add_query_arg(['fcm_action' => 'players_admin', 'action' => 'edit', 'id' => $zawodnik->id], get_permalink())) . '" class="button">Edytuj</a> ';
